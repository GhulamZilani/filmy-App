...
const Reviews=({id, prevRating, userRated}) =>{
    ...
    <div className='mt-4 border-t-2 border-gray-700 w-full'>
        ...
        placeholder='Share Your thoughts...' className='w-full p-2 outline-none header'/>
        <button onClick={sendReviews} className='bg-green-600 flex justify-center w-full p-2'>
        ...
        :
        <div className='mt-4'>{data.map((e, i)=>{
            return(
